...
import net.hp.es.adm.healthcare.rphcp.utils.JettyServer;
...
public class QuickStartServer {  
	...
	public static final String[] TLD_JAR_NAMES = new String[] {"spring-webmvc", "shiro-web",
			"springside-core" };
	// 添加组件路径
	private static final String KETA_CUSTOM_COMPONENT_RESOURCES = "../RHIP-component/src/main/webapp";
	private static final String KETA_CUSTOM_COMPONENT_CLASSES = "../RHIP-component/target/classes";
