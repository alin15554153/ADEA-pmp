...
<beans xmlns="http://www.springframework.org/schema/beans"
	...
	<context:component-scan base-package="net.hp.es.adm.healthcare,${packageName}" use-default-filters="false">
		<context:include-filter type="annotation" expression="org.springframework.stereotype.Controller"/>
		<context:include-filter type="annotation" expression="org.springframework.web.bind.annotation.ControllerAdvice"/>
	</context:component-scan>
	
	<!-- 系统日志跟踪功能 -->
	<bean id="log4JDBCImpl" class="net.hp.es.adm.healthcare.rphcp.log.impl.Log4JDBCImpl" >
		<property name="logInfoService" ref="logInfoServiceImpl"/>
		<property name="rootLogLevel" value="ERROR"/>
		<property name="customLogLevel">
           <map>
              <entry key="net.hp.es.adm.healthcare.rphcp" value="TRACE" />
	...
	<mvc:interceptors>
		...
		<mvc:interceptor>
			<mvc:mapping path="/**" />
			<bean class="net.hp.es.adm.healthcare.rphcp.spring.ExecuteTimeInterceptor" />
		</mvc:interceptor>
		 -->	
		<!-- 日志拦截记录 -->	
		<mvc:interceptor>
			...
			<bean class="net.hp.es.adm.healthcare.rphcp.log.spring.LogInterceptor" >
		...
		<mvc:interceptor>
			<mvc:mapping path="/**" />
			<bean class="net.hp.es.adm.healthcare.rphcp.spring.DataControlInterceptor" />
		</mvc:interceptor>	
	</mvc:interceptors>
